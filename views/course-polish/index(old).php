...
<header role="banner" id="fh5co-header" class="navbar-fixed-top">
    <div class="fluid-container">
        <nav class="navbar navbar-default">
            ...
            <p class="navbar-text">
                <i>Записаться на курсы: <br class="br-navbar-text"><span><i class="icon-call-in"></i>+38(096) 814 11 32</span></i>
            </p>
    ...
    <div class="container">
        ...
        <div class="row">
			<div class="col-md-12 text-right soc-block">
                <a target="_blank" href="<?=\yii\helpers\Url::to('https://www.facebook.com/studentway2017/')?>"><img src="/images/facebook_color.png" alt="" class="soc-icons"></a>
                ...
                <a target="_blank" href="<?=\yii\helpers\Url::to('https://www.youtube.com/user/kovalenkoo1964')?>"><img src="/images/youtube_color.png" alt="" class="soc-icons"></a>
            </div>
